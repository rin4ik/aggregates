...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0"> 
           ...
           <ul>
               <li>
                    {{$user->articles_count_alias}} {{Str::plural('article', $user->articles_count_alias)}}
                </li>
                <li>
                    {{$user->comments_count}} {{Str::plural('comment', $user->comments_count)}}
                </li>
                <li>
                    {{$user->comments_deleted_count}} {{Str::plural('deleted comment', $user->comments_deleted_count)}}
                </li>
                <li>
